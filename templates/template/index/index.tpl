...
<div class="Min_1">
  <div class="Min1_L">
    ...
    <div class="hdwrap">
      ...
      <div class="bd">
        <div class="tempWrap" style="overflow:hidden; position:relative; width:420px">
		  ...
		  <{if $v.id==345}>
		  <{section loop=$v.data_list.list name=news start=0 max=1}>
			<li class="clone">
              <div class="pic">
                <a href="<{$v.data_list.list[news].url}>" target="_blank">
                  <img src="https://www.jpkcnet.com/uploadimg/ico/2018/0511/1526034503162007.jpg"></a>
                <div class="btwrap">
                  <a href="https://www.jpkcnet.com/sm/bzsm.html" target="_blank"><{$v.data_list.list[news].title}></a></div>
              </div>
            </li>
			<{/section}>
			<{/if}>
    ...
    <!--推薦-->
    <div class="M1_itema">
      <a href="http://sm.03ky.com/?ac=pc" target="_blank">
  ...
  <div class="Min1_M">
   <{foreach from=$self_tid item=v key=k}>
   <{if $v.id==345 || $v.id==348 || $v.id==347}>
  <{section loop=$v.data_list.list name=news start=0 max=1}>
    <a href="<{$v.data_list.list[news].url}>" class="bta" target="_blank"><{$v.data_list.list[news].title}></a>
  <{/section}>
    <div class="btb">
	<{section loop=$v.data_list.list name=news start=1 max=6}>
      <div class="lis">
...
<div class="Min_2">
  ...
  <div class="M2_item">
    <a href="http://sm.03ky.com/?ac=pc" target="_blank" class="lis">
      <div class="img">
