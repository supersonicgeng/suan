...
<p class="bottom_words">关注百度【开运网】熊掌号，了解预约进展</p>
...
<div class="protocol_pop_box" id="protocolPopBox">
    <div class="ppb_content">
        ...
        <div class="ppb_text">
            <p>
                百度提醒您：在使用百度搜索引擎（以下简称百度）及开运网平台服务前，请您务必仔细阅读并透彻理解本声明。您可以选择不使用百度，但如果您使用百度，您的使用行为将被视为对本声明全部内容的认可。
            </p>
            <p>
                • 开运网平台中电话咨询、在线咨询信息、挂号及其他服务均由第三方服务商提供，不代表百度观点和立场。百度对第三方服务的可用性、真实性、准确性或有效性以及服务质量不提供任何形式的担保或保证。
            </p>
            <p>
            ...
            <p>
                • 您理解并保证，您对百度搜索引擎及开运网平台的使用，不会违反任何适用的法律、法规、政策及公共道德准则，也不会损害任何第三方的合法权益。
            </p>
            <p>
