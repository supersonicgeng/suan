            ...
            <form action="" target="_blank" method="get"
                ...
                <ul class="form-order-pay pay-methods payList payMethods">
                    <li class="btn-payment wxpay">
                        <a class="purl pay-weixinpay" href="statics/ffsm/mfqm/http://qiming.03ky.com/orders/89/real_pay?type=wechat" data-text="1301" data-paytype="2">
                            <span>微信支付</span>
                        </a>
                    </li>
                    <li class="btn-payment wxpay">
                        <a class="purl" style="color: #6cb333;background: none;font-size: .4rem;padding-bottom: .5rem;" href="statics/ffsm/mfqm/http://qiming.03ky.com/orders/2018072511215623937">微信支付成功后请点击此处</a>
                    </li>
                    <li class="btn-payment alipay">
                        <a class="purl pay-alipay" href="statics/ffsm/mfqm/http://qiming.03ky.com/orders/89/real_pay?type=alipay" data-text="12" data-paytype="1">
                            <span>支付宝支付</span>
                        </a>
                    </li>
                </ul>
