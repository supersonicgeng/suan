...
<div class="detail">
    <dl>
        <form name="form1" action="/index.php"  method="post">
            ...
            <dd class="form">请输入手机号: <input type="text" name="word" maxLength=32 class="ipt1" onBlur="if (value==''){value='11位手机号码'}" onFocus="if (value=='11位手机号码') {value=''}" value="11位手机号码" onKeyUp="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,''">
            </dd>
			</br>
