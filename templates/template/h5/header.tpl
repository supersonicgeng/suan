...
<div id="header">
    <div class="h_box index" id="wrap">
        ...
        <span class="fr"><a id="dhxlcd" href="javascript:;"><img src="/static/img/nav_more.png" height="24" border="0"></a></span>
        <ul class="fr">
           <li><a href="https://www.03ky.com/">官网</a></li>
            <li><a href="http://sm.03ky.com/?ac=bazizh">详批</a></li>
            <li><a href="https://www.03ky.com/forum.php?forumlist=1">社区</a></li>
        </ul>
    </div>
</div>
...
function dhxlcdgn_add() {
    ...
    var html = '<nav id="dhxlcdgn" class="dhxlcdgn">' +
		...
		'<p>开运网你身边值得信赖的命理顾问专家</p>' +
            ...
            '<li><a href="http://sm.03ky.com/?ac=yinyuancs">感情</a></li>' +
		    ...
		    '<li><a href="http://sm.03ky.com/?ac=xmfx">姓名</a></li>' +
            ...
            '<li><a href="http://sm.03ky.com/?ac=hehun">合婚</a></li>' +
	    ...
	    '</ul>' +
	    '<ul class="nav_icon">' +
		    '<li><a href="http://sm.03ky.com/?ac=hehun"><img src="https://www.03ky.com/m/tu/cs/111.png" />配对</a></li>' +
		    '<li><a href="http://sm.03ky.com/?ac=yinyuancs"><img src="https://www.03ky.com/m/tu/cs/99.png" />姻缘</a></li>' +
		    '<li><a href="http://sm.03ky.com/?ac=bazi"><img src="https://www.03ky.com/m/tu/cs/44.png" />批八字</a></li>' +
		    '<li><a href="http://sm.03ky.com/?ac=xmfx"><img src="https://www.03ky.com/m/tu/cs/88.png" />姓名</a></li>' +
		    '<li><a href="http://sm.03ky.com/?ac=bazizh"><img src="https://www.03ky.com/m/tu/cs/pibazi1.png" />综合</a></li>' +
