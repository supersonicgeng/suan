<?php /* Smarty version 2.6.25, created on 2019-07-04 12:19:44
        ...
        <div class="f-box">
         <ul class="form">
          ...
          <li class="clear">
           ...
           <div class="auto">
            <input type="text" id="birthday" data-input-id="b_input" class="Js_date" data-type="0" value="请选择出生日期" placeholder="请选择日期" data-toid-hour="birthday"   data-date="1985-3-1" readonly="" placeholder="请选择(必填)" />
           </div></li>
          <li class="textarea">
           <div class="label">
            您的愿望:
