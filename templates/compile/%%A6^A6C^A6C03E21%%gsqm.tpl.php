<?php /* Smarty version 2.6.25, created on 2019-07-08 11:39:35
         compiled from ffsm/gsqm.tpl */ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8"/>
<title>公司在线起名,公司在线取名,新公司测名起名</title>
	...
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=gsqm" name="login" method="post" onSubmit="return checkForm();">
		<div class="public_form_wrap" id="miaodian">
			<ul>
				...
				<div class="auto">
					<input type="text" class="bg_no" id="name" name="name" placeholder="如：开运网络（不需填有限公司）" value=""/>
				</div>
				</li>
				<li>
				<div class="left">
