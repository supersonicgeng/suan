<?php /* Smarty version 2.6.25, created on 2019-07-03 15:53:38
         compiled from ffsm/hmjx_find2.tpl */ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
                ...
                <ul class="szjx_top_wrap">
                    <li class="szjx_top_r">
                        ...
                        <p><?php echo $this->_tpl_vars['data']['data']['word']; ?>
                                        ...
                                        <li class="szjx_top_r">
                        <p>数字磁场组合</p>
                        <p>(<?php echo $this->_tpl_vars['word_cp']; ?>
)<?php echo $this->_tpl_vars['haomajx']['0']['jx']; ?>
</p>
                    </li>
                    <li class="szjx_top_r">
                            <p>(<?php echo $this->_tpl_vars['word_cp']; ?>
