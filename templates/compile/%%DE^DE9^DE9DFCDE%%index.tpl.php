<?php /* Smarty version 2.6.25, created on 2019-07-10 10:29:46
...
<link rel="stylesheet" type="text/css" href="statics/ffsm/index/swiper.min.css">
	...
	<div id="container">
		...
		<div id="vue_app" v-cloak>
			...
			<div class="container">
				...
				<div class="banner">
                    <img src="statics/ffsm_2019/index/picture/ny-bottombanner1.png" alt="图片" width="100%">
				 </div>
                <!--今日黄历-->
<div id="huangli">
<div class="lhlkj">
...
<!--结束-->
				...
				<div class="bottom-banner">
					<img src="statics/ffsm_2019/index/picture/ny-bottombanner2.png" alt="图片" width="100%">
				</div>
            ...
            return {
                list:[
                    ...
                    },
                 {
                    ...
                    {
                        jump_url: '/?ac=bazi',
                        theme_img: 'theme-img12.png',
                        theme_icon: 'theme-icon12.png',
                        theme: '事业财运',
                        order_type: 9,
                        pay_total: '',
                        theme_btn: 'theme-btn12.png'
                    },
                      {
                        jump_url: '/?ac=bzyy',
                        theme_img: 'theme-img13.png',
                        theme_icon: 'theme-icon13.png',
                        theme: '月老姻缘',
                        order_type: 9,
                        pay_total: '',
                        theme_btn: 'theme-btn13.png'
                    },
                      {
                        jump_url: '/?ac=gsqm',
                        theme_img: 'theme-img14.png',
                        theme_icon: 'theme-icon14.png',
                        theme: '公司起名',
                        order_type: 9,
                        pay_total: '',
                        theme_btn: 'theme-btn14.png'
                    },
                      /*{
                        jump_url: '/?ac=ffqm',
                        theme_img: 'theme-img15.png',
                        theme_icon: 'theme-icon15.png',
                        theme: '十二生肖',
                        order_type: 9,
                        pay_total: '',
                        theme_btn: 'theme-btn15.png'
                    },*/
                      {
                        jump_url: '/?ac=xmpd',
                        theme_img: 'theme-img16.png',
                        theme_icon: 'theme-icon16.png',
                        theme: '姓名配对',
                        order_type: 9,
                        pay_total: '',
                        theme_btn: 'theme-btn16.png'
                    },
