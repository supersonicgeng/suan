...
$input->SetNotify_url("http://sm.03ky.com/payment/Wxpay_gz/example/native_callback.php");
...
<div id="code"><img src="http://sm.03ky.com/payment/Wxpay_gz/example/qrcode.php?data=<?php echo urlencode($url2);?>"></div>
<p></p>
