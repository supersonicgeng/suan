...
$input->SetNotify_url("https://sm.03ky.com/payment/Wxpay_gz/example/native_callback.php");
...
<div id="code"><img src="https://sm.03ky.com/payment/Wxpay_gz/example/qrcode.php?data=<?php echo urlencode($url2);?>"></div>
<p></p>
